...
/* 800D8DD8 000D46F8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8DDC 000D46FC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8DE0
func_800D8DE0:
/* 800D8DE0 000D4700  7C 60 01 24 */	mtmsr r3
/* 800D8DE4 000D4704  4E 80 00 20 */	blr 
/* 800D8DE8 000D4708  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8DEC 000D470C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8DF0
func_800D8DF0:
/* 800D8DF0 000D4710  7C 70 FA A6 */	mfspr r3, 0x3f0
/* 800D8DF4 000D4714  4E 80 00 20 */	blr 
/* 800D8DF8 000D4718  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8DFC 000D471C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E00
func_800D8E00:
/* 800D8E00 000D4720  7C 70 FB A6 */	mtspr 0x3f0, r3
/* 800D8E04 000D4724  4E 80 00 20 */	blr 
/* 800D8E08 000D4728  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E0C 000D472C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E10
func_800D8E10:
/* 800D8E10 000D4730  7C 79 FA A6 */	mfspr r3, 0x3f9
/* 800D8E14 000D4734  4E 80 00 20 */	blr 
/* 800D8E18 000D4738  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E1C 000D473C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E20
func_800D8E20:
/* 800D8E20 000D4740  7C 79 FB A6 */	mtspr 0x3f9, r3
/* 800D8E24 000D4744  4E 80 00 20 */	blr 
/* 800D8E28 000D4748  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E2C 000D474C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E30
func_800D8E30:
/* 800D8E30 000D4750  7C 76 03 A6 */	mtspr 0x16, r3
/* 800D8E34 000D4754  4E 80 00 20 */	blr 
/* 800D8E38 000D4758  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E3C 000D475C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E40
func_800D8E40:
/* 800D8E40 000D4760  44 00 00 02 */	sc 
/* 800D8E44 000D4764  4E 80 00 20 */	blr 
/* 800D8E48 000D4768  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E4C 000D476C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800D8E64 000D4784  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E68 000D4788  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E6C 000D478C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E70
func_800D8E70:
/* 800D8E70 000D4790  7C 78 EB A6 */	mtspr 0x3b8, r3
/* 800D8E74 000D4794  4E 80 00 20 */	blr 
/* 800D8E78 000D4798  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E7C 000D479C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E80
func_800D8E80:
/* 800D8E80 000D47A0  7C 7C EB A6 */	mtspr 0x3bc, r3
/* 800D8E84 000D47A4  4E 80 00 20 */	blr 
/* 800D8E88 000D47A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E8C 000D47AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8E90
func_800D8E90:
/* 800D8E90 000D47B0  7C 79 EB A6 */	mtspr 0x3b9, r3
/* 800D8E94 000D47B4  4E 80 00 20 */	blr 
/* 800D8E98 000D47B8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8E9C 000D47BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8EA0
func_800D8EA0:
/* 800D8EA0 000D47C0  7C 7A EB A6 */	mtspr 0x3ba, r3
/* 800D8EA4 000D47C4  4E 80 00 20 */	blr 
/* 800D8EA8 000D47C8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8EAC 000D47CC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8EB0
func_800D8EB0:
/* 800D8EB0 000D47D0  7C 7D EB A6 */	mtspr 0x3bd, r3
/* 800D8EB4 000D47D4  4E 80 00 20 */	blr 
/* 800D8EB8 000D47D8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8EBC 000D47DC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8EC0
func_800D8EC0:
/* 800D8EC0 000D47E0  7C 7E EB A6 */	mtspr 0x3be, r3
/* 800D8EC4 000D47E4  4E 80 00 20 */	blr 
/* 800D8EC8 000D47E8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8ECC 000D47EC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800D8F18 000D4838  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8F1C 000D483C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8F20
func_800D8F20:
/* 800D8F20 000D4840  7C 78 E2 A6 */	mfspr r3, 0x398
/* 800D8F24 000D4844  4E 80 00 20 */	blr 
/* 800D8F28 000D4848  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8F2C 000D484C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8F30
func_800D8F30:
/* 800D8F30 000D4850  7C 78 E3 A6 */	mtspr 0x398, r3
/* 800D8F34 000D4854  4E 80 00 20 */	blr 
/* 800D8F38 000D4858  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8F3C 000D485C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800D8F4C 000D486C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8F50
func_800D8F50:
/* 800D8F50 000D4870  7C 79 E3 A6 */	mtspr 0x399, r3
/* 800D8F54 000D4874  4E 80 00 20 */	blr 
/* 800D8F58 000D4878  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8F5C 000D487C  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
...
/* 800D8F88 000D48A8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8F8C 000D48AC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */

.global func_800D8F90
func_800D8F90:
/* 800D8F90 000D48B0  FF A0 00 4C */	mtfsb1 0x1d
/* 800D8F94 000D48B4  4E 80 00 20 */	blr 
/* 800D8F98 000D48B8  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
/* 800D8F9C 000D48BC  00 00 00 00 */	.4byte 0x00000000  /* unknown instruction */
